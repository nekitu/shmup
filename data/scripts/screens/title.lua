...
local function project(x, y, z, center)
  local screen = Vec2()
  if z > 0 then
      screen.x = x / z * zoom + center.x
      screen.y = y / z * zoom + center.y
  end
  return screen
end
...
function C:onRender()
  ...
  for i = 0, 10 do
    local p0 = {x = 70, y = -500, z = 2}
    local p1 = {x = 70, y = -500, z = 1}
    local p2 = {x = 70, y = -500 + 80, z = 1}
    local p3 = {x = 70, y = -500 + 80, z = 2}
